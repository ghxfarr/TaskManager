...
public class TaskManager {
    ...
    public void addTask(String description, Status status, LocalDate startDate, LocalDate dueDate) {
    ...
    public boolean editTask(int id, String newDescription, Status newStatus, LocalDate newStartDate, LocalDate newDueDate) {
